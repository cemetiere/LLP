...
int32_t joinTables(struct JoinResult *joinResult, int32_t selectColumnsNum, struct TableAliasAndColumn *selectColumns,
    ...
    for (int32_t currentRecordCombinationIndex = 0;
        ...
        if (satisfies) {
            ...
            addRow(joinTableHeader, joinedRowRecordData);
        }
